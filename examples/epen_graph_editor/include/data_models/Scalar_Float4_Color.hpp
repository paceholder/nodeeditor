...
public:
    ...
    Q_PROPERTY(double Default_Red MEMBER _red WRITE setRed NOTIFY propertyChanged)
    Q_PROPERTY(double Default_Green MEMBER _green WRITE setGreen NOTIFY propertyChanged)
    Q_PROPERTY(double Default_Blue MEMBER _blue WRITE setBlue NOTIFY propertyChanged)
    Q_PROPERTY(double Default_Alpha MEMBER _alpha WRITE setAlpha NOTIFY propertyChanged)
